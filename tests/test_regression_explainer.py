...
def test_plot_predicted_vs_actual(precalculated_rf_regression_explainer):
    ...
    fig = precalculated_rf_regression_explainer.plot_predicted_vs_actual(
...
def test_plot_residuals_vs_feature(precalculated_rf_regression_explainer):
    ...
    fig = precalculated_rf_regression_explainer.plot_residuals_vs_feature(
...
def test_plot_y_vs_feature(precalculated_rf_regression_explainer):
    ...
    fig = precalculated_rf_regression_explainer.plot_y_vs_feature(
        "Gender", points=False
    )
    assert isinstance(fig, go.Figure)
...
def test_plot_preds_vs_feature(precalculated_rf_regression_explainer):
    ...
    fig = precalculated_rf_regression_explainer.plot_preds_vs_feature(
        "Age", dropna=True
    )
    assert isinstance(fig, go.Figure)
