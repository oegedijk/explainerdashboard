...
def test_simple_classification_dashboard(
...
def test_xgboost_classification_dashboard(
    dash_duo, precalculated_xgb_classifier_explainer
):
    db = ExplainerDashboard(
...
def test_classification_dashboard_no_y(
    dash_duo, precalculated_rf_classifier_explainer_no_y
):
    db = ExplainerDashboard(
...
def test_regression_dashboard_no_y(
    dash_duo, precalculated_rf_regression_explainer_no_y
):
    db = ExplainerDashboard(
...
def test_multiclass_dashboard_no_y(
    dash_duo, precalculated_rf_multiclass_explainer_no_y
):
    db = ExplainerDashboard(
...
def test_catboost_classification_dashboard(
    dash_duo, precalculated_catboost_classifier_explainer
):
    db = ExplainerDashboard(
...
def test_catboost_regression_dashboard(
    dash_duo, precalculated_catboost_regression_explainer
):
    db = ExplainerDashboard(
